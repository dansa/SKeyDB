...
import {getDatabaseRouteBoundaryKey} from '@/features/database/detail/database-detail-history'
...
function App() {
  ...
  const routeErrorBoundaryKey = getDatabaseRouteBoundaryKey(pathname, locationState)
