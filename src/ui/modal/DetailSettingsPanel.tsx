...
export function DetailSettingsPanel({
  ...
  return (
    <div
      className='absolute top-[calc(100%+0.45rem)] right-0 z-[905] w-[min(24rem,calc(100vw-2rem))] border border-amber-200/40 bg-slate-950/[.985] p-3 shadow-[0_16px_36px_rgba(2,6,23,0.64)]'
      ...
      <div className='space-y-3'>
        ...
        <div>
          <div className='grid gap-3 sm:grid-cols-[minmax(0,1fr)_7rem] sm:items-end'>
            <div>
              <p
                className='mb-1 text-[10px] tracking-[0.16em] text-slate-500 uppercase'
                id={fontScaleLabelId}
              >
                Default text size
              </p>
