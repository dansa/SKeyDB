...
export function ExportCodeDialog({ title, code, onClose }: ExportCodeDialogProps) {
  ...
  return (
    <ModalFrame title={title}>
      <p className="mt-2 text-sm text-slate-200">Copy this code to share/import later.</p>
      <textarea
