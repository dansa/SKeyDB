...
describe('import planner', () => {
  it('requires strategy for single-team imports with duplicate awakeners', () => {
    const current = [
      makeTeam('Team 1', {
        slots: [
          {slotId: 'slot-1', awakenerId: 'awakener-0042', realm: 'CHAOS', wheels: [null, null]},
          {slotId: 'slot-2', wheels: [null, null]},
          {slotId: 'slot-3', wheels: [null, null]},
          {slotId: 'slot-4', wheels: [null, null]},
        ],
    ...
    const incoming = makeTeam('Imported', {
      slots: [
        {slotId: 'slot-1', awakenerId: 'awakener-0020', realm: 'CHAOS', wheels: [null, null]},
        {slotId: 'slot-2', wheels: [null, null]},
        {slotId: 'slot-3', wheels: [null, null]},
        {slotId: 'slot-4', wheels: [null, null]},
      ],
  ...
  it('applies move strategy by removing duplicates from existing teams', () => {
    ...
    const imported = makeTeam('Imported', {
      posseId: 'taverns-opening',
      slots: [
        {slotId: 'slot-1', awakenerId: 'awakener-0021', realm: 'AEQUOR', wheels: ['SR19', null]},
        {slotId: 'slot-2', wheels: [null, null]},
        {slotId: 'slot-3', wheels: [null, null]},
        {slotId: 'slot-4', wheels: [null, null]},
      ],
    ...
    expect(result.teams[0].slots[0]).toEqual({
      slotId: 'slot-1',
    ...
    expect(result.teams.at(-1)?.slots[0].awakenerId).toBe('awakener-0021')
  })
  ...
  it('applies skip strategy by dropping conflicting entries from imported team', () => {
    ...
    expect(importedTeam.slots[0]).toEqual({
      slotId: 'slot-1',
      awakenerId: undefined,
      realm: undefined,
      level: undefined,
  ...
  it('treats both wheel slots as globally unique for import conflicts', () => {
    ...
    const incoming = makeTeam('Imported', {
      slots: [
        {slotId: 'slot-1', awakenerId: 'awakener-0042', realm: 'CHAOS', wheels: ['C01', 'SR20']},
        {slotId: 'slot-2', wheels: [null, null]},
        {slotId: 'slot-3', wheels: [null, null]},
        {slotId: 'slot-4', wheels: [null, null]},
      ],
  ...
  it('requires duplicate override when imported payload is duplicate-illegal under strict rules', () => {
    const incomingTeams = [
      makeTeam('Wave 1', {
        slots: [
          {slotId: 'slot-1', awakenerId: 'awakener-0021', realm: 'AEQUOR', wheels: [null, null]},
          {slotId: 'slot-2', wheels: [null, null]},
          {slotId: 'slot-3', wheels: [null, null]},
          {slotId: 'slot-4', wheels: [null, null]},
        ],
