...
- Switching active team must be explicit (button-based), not row click.
...
- Team CRUD basics:
  - add team (up to 10),
  - set active team (explicit `Edit Team` action),
...
- Done:
  ...
  - Team add/edit/delete with explicit centered confirm/cancel delete confirmation.
